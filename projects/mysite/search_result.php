...
<div class="box-heading">
    <h1 class="mijoshop_heading_h1">The search results
</h1>
</div>
...
if(isset($_POST["searchword"])){
	$_SESSION['searchword']=$_POST["searchword"];
														...
														$sql = mysqli_query($conn,"select * from tb_shangpin where mingcheng like '%".$_SESSION['searchword']."%'");
														$count = mysqli_num_rows($sql);
														if($count == 0){
															echo "<script>alert('No Searched record
			...
			if (!isset($_GET['page'])) {
				...
				if($_GET['page']<0){
					...
					$page = $_GET['page'];
														...
														$sql = mysqli_query($conn,"select t1.id,t1.tupian,t1.mingcheng,t1.huiyuanjia,t2.typename from tb_shangpin t1,tb_type t2 where t1.typeid=t2.id and t1.mingcheng like '%".$_SESSION['searchword']."%' order by addtime desc limit ".($page-1)*$pagesize.",".$pagesize);
																	...
																	<div class="name">
																		<a
																			href="goodsDetail.php?id=<?php echo $info['id'];?>" style="width:95%">
																			 <span style="color:#0885B1">Product name:</span><?php echo $info['mingcheng'];?></a>
																	</div>															
...
<div class="row pagination">
  ...
  <tr>
	...
	<?php if($page>1){?>
	<a href="search_result.php?page=1">First page</a>　<a href="search_result.php?page=<?php echo $page-1;?>">Previous page</a>
	<?php
	}
	if($page<$maxPage){
	?>
	　<a href="search_result.php?page=<?php echo $page+1;?>">Next page</a>　<a href="search_result.php?page=<?php echo $maxPage;?>">Last page&nbsp;</a>
	<?php }
	?>
	</td>
  </tr>
